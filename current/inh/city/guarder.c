...
void do_enter( object who, object me )
{
        ...
        switch( name2 )
        {
  case "齐国" : z = 10;  p = get_jumpin( z, me->get("in") );  break;
  case "韩国" : z = 20;  p = get_jumpin( z, me->get("in") );  break;
  case "赵国" : z = 30;  p = get_jumpin( z, me->get("in") );  break;
  case "魏国" : z = 40;  p = get_jumpin( z, me->get("in") );  break;
  case "秦国" : z = 50;  p = get_jumpin( z, me->get("in") );  break;
  case "楚国" : z = 60;  p = get_jumpin( z, me->get("in") );  break;
  case "燕国" : z = 70;  p = get_jumpin( z, me->get("in") );  break;
      default :
  case "周国" : z = 80;  p = get_jumpin( z, me->get("in") );  break;
        }
...
void do_out( object who, object me )
{
        ...
        {
  case "齐国" : z = 10;  p = get_jumpin( z, me->get("out") ); 
//                who->set_latest_city( z * 100 + me->get("out") ); 
                break;
  case "韩国" : z = 20;  p = get_jumpin( z, me->get("out") );  
//                who->set_latest_city( z * 100 + me->get("out") ); 
                break;
  case "赵国" : z = 30;  p = get_jumpin( z, me->get("out") );  
//                who->set_latest_city( z * 100 + me->get("out") ); 
                break;
  case "魏国" : z = 40;  p = get_jumpin( z, me->get("out") );  
//                who->set_latest_city( z * 100 + me->get("out") ); 
                break;
  case "秦国" : z = 50;  p = get_jumpin( z, me->get("out") );  
//                who->set_latest_city( z * 100 + me->get("out") ); 
                break;
  case "楚国" : z = 60;  p = get_jumpin( z, me->get("out") );  
//                who->set_latest_city( z * 100 + me->get("out") ); 
                break;
  case "燕国" : z = 70;  p = get_jumpin( z, me->get("out") );  
//                who->set_latest_city( z * 100 + me->get("out") ); 
                break;
      default :
  case "周国" : z = 80;  p = get_jumpin( z, me->get("out") );  
...
void do_record( object who, object me )
{
	  ...
	  case "燕国" : z = 70;  p = get_jumpin( z, me->get("out") );  
	                ...
	                break;
	      default :
	  case "周国" : z = 80;  p = get_jumpin( z, 10 );  
