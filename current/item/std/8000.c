...
int get_use_effect_callout( object me, object item )
{
	...
	me->add_potential(p/500+1);
        ...
        else if( p < 30 )    // 妖怪
        {
                ...
                {
              default : result = "洞庭水贼";  pic = 8010;  level2 = 6;  break;
              case 45 : result = "山西土匪";  pic = 0251;  level2 = 2;  break;
              case 55 : result = "太行山贼";  pic = 8011;  level2 = 4;  break;
              case 65 : result = "中原大盗";  pic = 0252;  level2 = 8;  break;
              case 75 : result = "山东响马";  pic = 8012;  level2 = 1;  break;
              case 85 : result = "关外马贼";  pic = 8012;  level2 = 3;  break;
              case 95 : result = "长白山贼";  pic = 8011;  level2 = 7;  break;
             case 105 : result = "漠北马贼";  pic = 8013;  level2 = 5;  break;
                }
        ...
        else if( p < 38 )    // 僵尸
        {
			...
			npc->add_ap( level * 150 / 100 );
                ...
                write_user( me, ECHO "您挖宝惊动了守护宝藏的僵尸！" );
        }
        else if ( p < 39 )	//2级晶石
        {
