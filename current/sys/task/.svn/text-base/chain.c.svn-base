...
mapping nChainNpc = ([
	"新手村" : ({"李老汉", "陈老头", "刘大叔", "黄大叔", "李大伯", "孟氏", "孟大伯", "马老汉", "孔老头", "丁大叔", }),
	"齐国" : ({"齐总管", "齐管家", "齐国百姓", "李屠", "李浪", "孙老头", "王凯", "孔小飞", "崔玉", "齐小贩", "雷霸天", "棋童小红", "棋童小黑", "罗天", "玉器商", }),
	"韩国" : ({"韩总管", "韩管家", "马大汉", "赵木", "林为", "游子", "钱老八", "李方士", "刘方士", "韩平", "乐师", "向棋师", "沈文",}),
	"赵国" : ({"赵总管", "赵管家", "王铁匠", "脚夫 ", "李防", "白易", "吕不韦", "赵姬", }),
	"魏国" : ({"魏总管", "魏管家", "程林开", "周童", "李三婶", "李大毛 ", "许氏", " 纱纤小姐", "刘德", "孟求", "孙少爷", "朱狂", "花匠", "李德", "魏老汉", "秀丽小姐", "崔大官人", "寻儿",}),
	"秦国" : ({"秦总管", "秦管家", "彭尖豪", "马显", "夏侯党", "瘾君子", "贝贝", "秦老汉", "程强", "秦药师",}),
	"楚国" : ({"楚总管", "楚管家", "刘头", "钱老九", "孙陆", "王满", "丁小丫", "茶叶商", "黎老汉", "赌徒甲", "赌徒乙", "赌徒丙", "赌徒丁", }),
	"燕国" : ({"燕总管", "燕管家", "曹清", "丁鹤年", "程风", "刘老板", "燕老汉", "燕苍天 ", "药材商", "古董商", }),
]);
