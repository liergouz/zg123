...
case "桃花源" : hp = me->set_temp_hp( "con", me->get_con() * COUND_d->get_1(0, 1) / COUND_d->get_2(0, 1) );  break;
  case "蜀山" : hp = me->set_temp_hp( "con", me->get_con() * COUND_d->get_1(0, 2) / COUND_d->get_2(0, 2) );  break;
case "禁卫军" : hp = me->set_temp_hp( "con", me->get_con() * COUND_d->get_1(0, 3) / COUND_d->get_2(0, 3) );  break;
  case "唐门" : hp = me->set_temp_hp( "con", me->get_con() * COUND_d->get_1(0, 4) / COUND_d->get_2(0, 4) );  break;
  case "茅山" : hp = me->set_temp_hp( "con", me->get_con() * COUND_d->get_1(0, 5) / COUND_d->get_2(0, 5) );  break;
case "昆仑山" : hp = me->set_temp_hp( "con", me->get_con() * COUND_d->get_1(0, 6) / COUND_d->get_2(0, 6) );  break;
case "云梦泽" : hp = me->set_temp_hp( "con", me->get_con() * COUND_d->get_1(0, 7) / COUND_d->get_2(0, 7) );  break;
        }
	rate = 0;
        ...
        if( p = me->get_skill(SKILL_0334) ) add += p * 4;    // 强化周天运转（蜀山）
...
case "桃花源" : mp = me->set_temp_mp( "spi", me->get_spi() * COUND_d->get_1(1, 1) / COUND_d->get_2(1, 1) );  break;
  case "蜀山" : mp = me->set_temp_mp( "spi", me->get_spi() * COUND_d->get_1(1, 2) / COUND_d->get_2(1, 2) );  break;
case "禁卫军" : mp = me->set_temp_mp( "spi", me->get_spi() * COUND_d->get_1(1, 3) / COUND_d->get_2(1, 3) );  break;
  case "唐门" : mp = me->set_temp_mp( "spi", me->get_spi() * COUND_d->get_1(1, 4) / COUND_d->get_2(1, 4) );  break;
  case "茅山" : mp = me->set_temp_mp( "spi", me->get_spi() * COUND_d->get_1(1, 5) / COUND_d->get_2(1, 5) );  break;
case "昆仑山" : mp = me->set_temp_mp( "spi", me->get_spi() * COUND_d->get_1(1, 6) / COUND_d->get_2(1, 6) );  break;
case "云梦泽" : mp = me->set_temp_mp( "spi", me->get_spi() * COUND_d->get_1(1, 7) / COUND_d->get_2(1, 7) );  break;
        }
	rate = 0;
...
case "桃花源" : ap = me->set_temp_ap( "str", me->get_str() * COUND_d->get_1(2, 1) / COUND_d->get_2(2, 1) );  break;
  case "蜀山" : ap = me->set_temp_ap( "str", me->get_str() * COUND_d->get_1(2, 2) / COUND_d->get_2(2, 2) );  break;
case "禁卫军" : ap = me->set_temp_ap( "str", me->get_str() * COUND_d->get_1(2, 3) / COUND_d->get_2(2, 3) );  break;
  case "唐门" : 
  		ap = me->set_temp_ap( "str", me->get_str() * COUND_d->get_1(2, 4) / COUND_d->get_2(2, 4) );  
  		ap += me->get_dex()/2;
  		break;
  case "茅山" : ap = me->set_temp_ap( "str", me->get_str() * COUND_d->get_1(2, 5) / COUND_d->get_2(2, 5));  break;
case "昆仑山" : ap = me->set_temp_ap( "str", me->get_str() * COUND_d->get_1(2, 6) / COUND_d->get_2(2, 6) );  break;
case "云梦泽" : ap = me->set_temp_ap( "str", me->get_str() * COUND_d->get_1(2, 7) / COUND_d->get_2(2, 7) );  break;
        }
	rate = 0;
...
case THROWING : if( p = me->get_skill(SKILL_0161) ) ap += me->set_temp_ap( "0161", p * 3 / 2 );    // 暗器投射
   ...
   case BLADE : if( p = me->get_skill(SKILL_0121) ) ap += me->set_temp_ap( "0121", p );    // 基本刀法
                ...
                if( p = me->get_skill(SKILL_0331) ) ap += me->set_temp_ap( "0331", p * 3 );    // 强化天罗刀法
                break;
...
case "桃花源" : dp = me->set_temp_dp( "cps", me->get_cps() * COUND_d->get_1(3, 1) / COUND_d->get_2(3, 1) );  break;
  case "蜀山" : dp = me->set_temp_dp( "cps", me->get_cps() * COUND_d->get_1(3, 2) / COUND_d->get_2(3, 2) );  break;
case "禁卫军" : dp = me->set_temp_dp( "cps", me->get_cps() * COUND_d->get_1(3, 3) / COUND_d->get_2(3, 3) );  break;
  case "唐门" : dp = me->set_temp_dp( "cps", me->get_cps() * COUND_d->get_1(3, 4) / COUND_d->get_2(3, 4) );  break;
  case "茅山" : dp = me->set_temp_dp( "cps", me->get_cps() * COUND_d->get_1(3, 5) / COUND_d->get_2(3, 5) );  break;
case "昆仑山" : dp = me->set_temp_dp( "cps", me->get_cps() * COUND_d->get_1(3, 6) / COUND_d->get_2(3, 6) );  break;
case "云梦泽" : dp = me->set_temp_dp( "cps", me->get_cps() * COUND_d->get_1(3, 7) / COUND_d->get_2(3, 7) );  break;
        }
	rate = 0;
...
case "桃花源" : cp = me->set_temp_cp( "spi", me->get_spi() * COUND_d->get_1(4, 1) / COUND_d->get_2(4, 1) );  break;
  case "蜀山" : cp = me->set_temp_cp( "spi", me->get_spi() * COUND_d->get_1(4, 2) / COUND_d->get_2(4, 2) );  break;
case "禁卫军" : cp = me->set_temp_cp( "spi", me->get_spi() * COUND_d->get_1(4, 3) / COUND_d->get_2(4, 3) );  break;
  case "唐门" : cp = me->set_temp_cp( "spi", me->get_spi() * COUND_d->get_1(4, 4) / COUND_d->get_2(4, 4) );  break;
  case "茅山" : cp = me->set_temp_cp( "spi", me->get_spi() * COUND_d->get_1(4, 5) / COUND_d->get_2(4, 5) );  break;
case "昆仑山" : cp = me->set_temp_cp( "spi", me->get_spi() * COUND_d->get_1(4, 6) / COUND_d->get_2(4, 6) );  break;
case "云梦泽" : cp = me->set_temp_cp( "spi", me->get_spi() * COUND_d->get_1(4, 7) / COUND_d->get_2(4, 7) );  break;
}
	rate = 0;
...
case "桃花源" : pp = me->set_temp_pp( "spi", me->get_spi() * COUND_d->get_1(5, 1) / COUND_d->get_2(5, 1) );  break;
  case "蜀山" : pp = me->set_temp_pp( "spi", me->get_spi() * COUND_d->get_1(5, 2) / COUND_d->get_2(5, 2) );  break;
case "禁卫军" : pp = me->set_temp_pp( "spi", me->get_spi() * COUND_d->get_1(5, 3) / COUND_d->get_2(5, 3) );  break;
  case "唐门" : pp = me->set_temp_pp( "spi", me->get_spi() * COUND_d->get_1(5, 4) / COUND_d->get_2(5, 4) );  break;
  case "茅山" : pp = me->set_temp_pp( "spi", me->get_spi() * COUND_d->get_1(5, 5) / COUND_d->get_2(5, 5) );  break;
case "昆仑山" : pp = me->set_temp_pp( "spi", me->get_spi() * COUND_d->get_1(5, 6) / COUND_d->get_2(5, 6) );  break;
case "云梦泽" : pp = me->set_temp_pp( "spi", me->get_spi() * COUND_d->get_1(5, 7) / COUND_d->get_2(5, 7) );  break;
	}
	rate = 0;
...
case "桃花源" : sp = me->set_temp_sp( "dex", me->get_dex() * COUND_d->get_1(6, 1) / COUND_d->get_2(6, 1) );  break;
  case "蜀山" : sp = me->set_temp_sp( "dex", me->get_dex() * COUND_d->get_1(6, 2) / COUND_d->get_2(6, 2) );  break;
case "禁卫军" : sp = me->set_temp_sp( "dex", me->get_dex() * COUND_d->get_1(6, 3) / COUND_d->get_2(6, 3) );  break;
  case "唐门" : sp = me->set_temp_sp( "dex", me->get_dex() * COUND_d->get_1(6, 4) / COUND_d->get_2(6, 4) );  break;
  case "茅山" : sp = me->set_temp_sp( "dex", me->get_dex() * COUND_d->get_1(6, 5) / COUND_d->get_2(6, 5) );  break;
case "昆仑山" : sp = me->set_temp_sp( "dex", me->get_dex() * COUND_d->get_1(6, 6) / COUND_d->get_2(6, 6) );  break;
case "云梦泽" : sp = me->set_temp_sp( "dex", me->get_dex() * COUND_d->get_1(6, 7) / COUND_d->get_2(6, 7) );  break;
        }
	rate = 0;
...
void count_hit_rate( object me )
{
   ...
   case STICK :
	...
	double2 += me->get_2("suit_effect.double_rate");
        if (double>4500) double = 4500;
        if (double2>4500) double2 = 4500;
        me->set_double_rate(double);
        me->set_double_rate_2(double2);
        
	fam = me->get_fam_name();
	if (fam=="昆仑山"||fam=="云梦泽"||fam=="蜀山")
...
void count_dodge_rate( object me )
{
        ...
        if( p = me->get_skill(0434) ) cent1 += p * 150;    	// 腾挪躲闪
