...
private static string *nFamily 	   = ({"桃花源","蜀山","禁卫军","唐门","茅山","昆仑山","云梦泽"});
...
void message() {
	...
	if ( !sizeof(nTmp) ) {
		nRobber = ({});
		CHAT_D->sys_channel(0, HIY"在大家共同的努力下，成功消灭了劫宝飞贼。那些飞贼吃了不少苦头之后，或许再也不敢出现了。");
		return ;
	}
	nRobber = nTmp;
...
void check_time() {
	...
	make_feizei();
	CHAT_D->sys_channel(0,HIY"一群刚劫完皇宫的盗贼逍遥法外，据说正逃窜在外。它们带着丰厚的宝物将在"HIR"新手村、楚方城1、首阳山、虎牢关、沼泽边缘、沼泽地带、郑国渠1、东海渔村、小沛、雪峰山密道、衡山密道、阴山草原、祁连山、琅琊密道、嵩山密道、弘农"HIY"出现！！！！");
	CHAT_D->sys_channel(0,HIY"一群刚劫完皇宫的盗贼逍遥法外，据说正逃窜在外。它们带着丰厚的宝物将在"HIR"新手村、楚方城1、首阳山、虎牢关、沼泽边缘、沼泽地带、郑国渠1、东海渔村、小沛、雪峰山密道、衡山密道、阴山草原、祁连山、琅琊密道、嵩山密道、弘农"HIY"出现！！！！");
	CHAT_D->sys_channel(0,HIY"一群刚劫完皇宫的盗贼逍遥法外，据说正逃窜在外。它们带着丰厚的宝物将在"HIR"新手村、楚方城1、首阳山、虎牢关、沼泽边缘、沼泽地带、郑国渠1、东海渔村、小沛、雪峰山密道、衡山密道、阴山草原、祁连山、琅琊密道、嵩山密道、弘农"HIY"出现！！！！");
	message();
...
void win_bonus_callout( object me, object who )
{
	...
	CHAT_D->sys_channel(0, HIY"据说劫宝飞贼已经被正义的玩家"+who->get_name()+"所消灭。" ); 
