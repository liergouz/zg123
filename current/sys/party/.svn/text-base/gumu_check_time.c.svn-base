...
void check_time1()
{
	...
	{
		for(i=0;i<3;i++)
		CHAT_D->sys_channel(0,HIR"轰～的一声，古墓探险传送人（周：276，163）已从睡梦中醒来，古墓探险活动现在正式开始啦～！大家赶快找到古墓探险传送人（周：276，163）去参加古墓探险活动吧！");
	}
	gumu=1;
...
{	int i;
	...
	{   
	   for(i=0;i<3;i++)
	   CHAT_D->sys_channel(0,HIR"轰～的一声，古墓探险传送人（周：276，163）又睡着了，今天的古墓探险活动结束啦！欢迎大家在明天同一时刻踊跃参加古墓探险！");
	}
	gumu=0;
