...
void reconnect( object me, object body )
{
        ...
        {
       case 0 : write_user(me, "您现在的攻击模式是：无限制攻击。" );  break;
       case 2 : write_user(me, "您现在的攻击模式是：队友保护。" );  break;
       case 3 : write_user(me, "您现在的攻击模式是：同城保护。" );  break;
       case 4 : write_user(me, "您现在的攻击模式是：帮派保护。" );  break;
      default : write_user(me, "您现在的攻击模式是：玩家保护。" );  break;
        }
