...
varargs void init_family( object me, int family, int level, int weapon )    // BOSS专用    // famliy 命令借用
{
        ...
        else
        {
               ...
               case 1 : gender = 1;
                        ...
                        me->set_spi_1(15);  me->set_spi_2(0);
                        me->set_str_1(25);  me->set_str_2(0);
                        me->set_cps_1(15);  me->set_cps_2(0);
                        me->set_dex_1(20);  me->set_dex_2(0);
                        break;
              default : gender = 2;
                        me->set_con_1(25);  me->set_con_2(0);
                        me->set_spi_1(25);  me->set_spi_2(0);
                        me->set_str_1(20);  me->set_str_2(0);
                        me->set_cps_1(20);  me->set_cps_2(0);
