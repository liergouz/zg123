...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n技能需求：40级\n    牺牲自己的召唤兽，并同时召唤出“神将”协助战斗。每次攻击，神将有3％的几率使敌人陷入3秒的眩晕状态。神将的召唤可维持15秒的时间。";
        cur_level = (level - SKILL_LEVEL)/20 + 1;
        result = sprintf(HIC"%s(%d级)\n" NOR "技能需求：%d级\n法力消耗：%d点\n冷却时间：%d秒\n    牺牲自己的召唤兽，并同时召唤出“神将”协助战斗。每次攻击，神将有%d％的几率使敌人陷入3秒的眩晕状态。神将的召唤可维持%d秒的时间。\n" HIC"下一级：\n"NOR"技能需求：" HIR "%d级" NOR"\n    提升神将1000点气血；\n    提升神将400点物理攻击力；\n    提升神将350点物理防御力；\n    提升神将350点法术防御力；\n    提升神将200点躲闪。\n    每次攻击，神将有%d％的几率使敌人陷入3秒的眩晕状态。神将的召唤可维持%d秒的时间。", 
