...
#define SUB_EFFECT      ( 30 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 5 * 10 )
#define SUB_EFFECT2      ( 20 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 5 * 5 )
...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n技能需求：5级\    腐蚀盔甲，使对手的物理防御力下降30点。法术防御力下降20点。效果持续120秒。";
        cur_level = (level - SKILL_LEVEL)/5 + 1;
        result = sprintf(HIC"%s(%d级)\n" NOR "技能需求：%d级\n法力消耗：%d点\n冷却时间：%d秒\n    腐蚀盔甲，使对手的物理防御力下降%d点。法术防御力下降%d点。效果持续120秒。\n" HIC"下一级：\n"NOR"技能需求：" HIR "%d级" NOR"\n    使对手的物理防御力下降%d点。法术防御力下降%d点。",
