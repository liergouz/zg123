...
{
	return HIC+get_name()+"\n拥有此技能的宠物，能探知以宠物自身为中心的\n7×7格范围内所有隐身的目标，技能有20秒冷冻时间";
}
// 函数：获取指令类型
...
//                32531, 1, OVER_BODY, 32531, 1, UNDER_FOOT, PF_ONCE );
        ...
        char = get_range_object(z, x, y, 3, USER_TYPE) + get_range_object(z, x, y, 3, CHAR_TYPE) - ({ me , owner });
