...
#define ADD_DAMAGE	( 20 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 10 * 5 )
...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n技能需求：18级\n    瞬间转移到敌人身后发动攻击，提升10点物理攻击力，命中目标的同时追加20％的伤害。";
        cur_level = (level - SKILL_LEVEL)/10 + 1;
        result = sprintf(HIC"%s(%d级)\n" NOR "技能需求：%d级\n法力消耗：%d点\n冷却时间：%d秒\n    瞬间转移到敌人身后发动攻击，提升%d点物理攻击力，命中目标的同时追加%d％的伤害。\n" HIC"下一级：\n"NOR"技能需求：" HIR "%d级" NOR"\n    提升%d点物理攻击力，命中目标的同时追加%d％的伤害。", 
