...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n技能需求：28级\n    投出手中的长枪击杀视线范围内的一个目标，追加80点物理攻击力，且攻击时对被攻击目标造成2秒的眩晕状态。";
        cur_level = (level - SKILL_LEVEL)/15 + 1;
        result = sprintf(HIC"%s(%d级)\n" NOR "技能需求：%d级\n元气消耗：%d\n冷却时间：%d秒\n    投出手中的长枪击杀视线范围内的一个目标，追加%d点物理攻击力，且攻击时对被攻击目标造成2秒的眩晕状态。\n" HIC"下一级：\n"NOR"技能需求：" HIR "%d级" NOR"\n    追加%d点物理攻击力，技能使用冷却时间减少至%d秒。", 
...
int main( object me, object who, int x, int y, string arg )
{
        ...
        {
                printf( ECHO "使用“" PF_NAME "”武器耐久度得高于 10。" );
                return 1;
        }
