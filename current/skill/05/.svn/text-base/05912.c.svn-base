...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n技能需求：16级\n消耗道具：阵旗×1\n    在目标3×3区域施放一个阵法，提升40点法术攻击力，持续8秒不断对阵法中的所有敌人造成法术伤害。";
        cur_level = (level - SKILL_LEVEL)/10 + 1;
        result = sprintf(HIC"%s(%d级)\n" NOR "技能需求：%d级\n法力消耗：%d点\n冷却时间：%d秒\n消耗道具：阵旗×1\n    在目标3×3区域施放一个阵法，提升%d点法术攻击力，持续8秒不断对阵法中的所有敌人造成法术伤害。\n" HIC"下一级：\n"NOR"技能需求：" HIR "%d级" NOR"\n    施放时提升%d点法术攻击力。",
...
void can_perform( object me )
{
	...
	send_user(me, "%c%w%w%c%c%c%c%c%s", 0x64, THIS_PERFORM, SUB_MP, 0,10, MAGIC_ACT_BEGIN, 0, 5, "阵旗");
}