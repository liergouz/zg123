...
{ 
        ...
        {
  case "齐国" : return sprintf( "data/org-1/%s%s", name, SAVE_EXTENSION ); 
  case "韩国" : return sprintf( "data/org-2/%s%s", name, SAVE_EXTENSION ); 
  case "赵国" : return sprintf( "data/org-3/%s%s", name, SAVE_EXTENSION ); 
  case "魏国" : return sprintf( "data/org-4/%s%s", name, SAVE_EXTENSION ); 
  case "秦国" : return sprintf( "data/org-5/%s%s", name, SAVE_EXTENSION ); 
  case "楚国" : return sprintf( "data/org-6/%s%s", name, SAVE_EXTENSION ); 
  case "燕国" : return sprintf( "data/org-7/%s%s", name, SAVE_EXTENSION ); 
