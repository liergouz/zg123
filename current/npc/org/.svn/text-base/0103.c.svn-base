...
void create()
{
        set_name( "恶人" + NPC_NAME_D->get_thief_name() );
...
void win_bonus( object who )
{
	...
	who->add_cash(cash);
	who->add_exp(exp);	
        send_user(who, "%c%s", ';', sprintf("你获得经验%d，潜能%d，金钱%d，帮贡增加了%d，帮派的人气提升2点、安定提升2点。", exp, pot, cash, 1+order*2/9));
