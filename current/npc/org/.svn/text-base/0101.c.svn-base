...
void do_push_callout( object who, object me, string arg )
{
        ...
        {
                send_user(who, "%c%s", '!', "您距离" + me->get_name() + "太远了。");
                return;
        }
        ...
        if( arg == "1" )
        {
                if( who->get_mp() < 10 )
                {
                        send_user(who, "%c%s", '!', "推开" + me->get_name() + "需要 10 点法力。");
                        return;
                }
                who->add_mp(-10);
              ...
              default :        y --;  break;
               ...
               case 8 : x ++;  y ++;  break;
                ...
                write_user( who, ECHO "您将" + me->get_name() + "推开。" );
//              write_user( me, ECHO "%s(%d)把您推开。", who->get_name(), who->get_number() );
        ...
        else if( arg == "2" )
        {
                if( who->get_mp() < 30 )
                {
                        send_user(who, "%c%s", '!', "扔出" + me->get_name() + "需要 30 点法力。");
                        return;
                }
                who->add_mp(-30);
                ...
                write_user( who, ECHO "您将" + me->get_name() + "扔了出去。" );
