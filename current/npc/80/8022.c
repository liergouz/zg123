...
void do_welcome2( object me, string arg )
{
	...
	case 2:
        ...
        case 4:
			...
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    全国通缉犯——叶青，你应该知道吧？最近他潜逃到燕国附近了，得赶紧把他捉拿归案，不然伤及更多的无辜百姓就不好了。\n    听说朝廷悬赏十万两黄金来捉拿他，如果你能将他干掉，那你可就发达了，趁这个消息还没走漏，赶紧去燕长城除掉他吧！\n"ESC"接受任务\ntalk %x# welcome.5\n"ESC"离开", me->get_name(),getoid(me)));
	...
	case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_ZHAOGUO,"赵国" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_ZHAOGUO,31,"叛国之徒" );
			send_user( who, "%c%s", '!', "得到任务 "HIY"叛国之徒");
        	}
        	break;
        case 6:
			...
			who->add_cash(6200);
			send_user(who,"%c%s",';',"叛国之徒 经验 7100 潜能 270 金钱 6200 高爆炸弹 5");
