...
void do_welcome2( object me, string arg )
{
	...
	case 5:
		if ( who->get_legend(TASK_41,18) && !who->get_legend(TASK_41,19) )
			...
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    天门阵法处于天门阵的层层守护之中，你先要破去阵图中的六劫煞，否则你还未碰到书就会离奇暴亡，幸亏我国细作潜入天门阵多年终于探得了六劫煞之名及其关键，可叹之前已有多个壮士无谓身死，六劫煞破除必须得是内力精纯、心底毫无旁骛之人，按照六劫煞的六劫方位逐一杀掉30个守阵天兵和30个守阵神将，你破除了六劫煞之后来告知我，我再教你如何做。\n"ESC"接受任务\ntalk %x# welcome.7\n"ESC"离开", me->get_name(),getoid(me)));
