...
void do_welcome2( object me, string arg )
{
        ...
        case 1:
			...
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    嘿，告诉你一个好消息，我将去拜访燕国的丁鹤年，这可是我朝思暮想了很久的事情！\n    燕国的丁鹤年是一个非常不错的人，我们神交已久，我对他的才学更是羡慕不已，从与他的书信往来中得知他就居住在燕国城内，一直想去拜访他，可从我这到燕国路途遥远，而我这家境……唉，不提也罢。最近想去拜访他的念头越来越强烈，苦于没有一件象样的礼物能拿得出手。\n    我听说易水的燕国巡逻兵爱喝酒，储藏了一批女儿红，你帮我这个忙，去那边给我找10坛来吧！\n"ESC"接受任务\ntalk %x# welcome.2\n"ESC"离开", me->get_name(),getoid(me)));
			...
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    其实我也知道魏国百姓乐羊条件不怎么样，但是他的生活能力比我强，他总是知道怎样过好日子，所以我才叫你去找他，这不，这么快你就给把我盘缠带来了！\n    这次真是太感谢你了，我终于能去拜访丁兄了。我马上就写信告诉丁兄这个好消息，我想他肯定也非常高兴！\n    等我从燕国回来，我会自己将钱还给孟求的。\n"ESC"完成任务\ntalk %x# welcome.5\n"ESC"离开", me->get_name(),getoid(me)));	
        	break;
        case 2:
        	if ( who->get_level() >= 25 && !who->get_legend(TASK_07,1)  )
        	{
