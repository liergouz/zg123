...
void do_welcome2( object me, string arg )
{
		...
		if ( who->get_legend(TASK_22,8) && !who->get_legend(TASK_22,9 ) )
			...
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    大王得知树妖长时间与太子殿下在秦长城幽会而自己士兵全部装聋作哑，而不劝回王子，诛杀树妖时，感觉到非常震怒，他下令赐死秦长城上10个秦国刀盾兵、10个秦国枪兵、10个秦国弓兵以儆效尤。杀完之后报秦国典狱官备案。\n"ESC"接受任务\ntalk %x# welcome.5\n"ESC"离开", me->get_name(),getoid(me)));
	...
	case 6:
		if ( who->get_legend(TASK_44,16) && !who->get_legend(TASK_44,17) )
			...
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    年轻人除了要有胆识，有阅历，细心也很重要，呃，上次我去诛仙阵寻找某个兵魂的时候竟然遇到了上古凶魂穷奇，慌忙之下只得用飞行苻跑路，回来发现把夫人交代我去齐国购买的琴宝斋的绣花针给掉在哪个角落了，如今夫人怪罪，我每日回家都会聆听一个时辰以上的夫人念咒大法，苦不堪言，现在考验你的机会到了，如果你能去到诛仙阵一层一趟给我找回绣花针，就证明你具备了细心这个条件。你可得看仔细了，或许就在某个宝箱里。里面的刀魂剑魂很有将拣到的任何东西放进宝箱藏起来的良好习惯，他们以为放进了宝箱东西就是自己的了，所以要小心他们的攻击，至于诛仙阵就在从太公府，进去后一直往前走，很容易就发现了，也许就在那个俑的旁边，上次就在那里遇到那个凶魂穷奇的，不过你放心，他是不会出现的，因为他老大据说已经把它收回去了。\n"ESC"接受任务\ntalk %x# welcome.8\n"ESC"离开", me->get_name(),getoid(me)));
