...
void do_welcome2( object me, string arg )
{
        ...
        case 4:
			...
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    我可是赵国大将军李牧，想跟着我混吗，很好，可是我手下从来不收无名之辈，新来的可得投个投名状，如果仅仅让你收拾个小瘪三那就太没有价值了，那样你最多能够作个小校，要是你想做更高的，那么就得接受我更艰巨的挑战，怎么准备好了吗，那好，你去万人坑杀掉刀盾骷髅10只、剑盾骷髅10只、双刀骷髅8只，如果完好无缺的回来本大将军自然会重用你。\n"ESC"接受任务\ntalk %x# welcome.5\n"ESC"离开", me->get_name(),getoid(me)));
	...
	case 21:
		if (who->get_level() >= 110 && !who->get_legend(TASK_43,26))
			...
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    啊，壮士，我是多么感激你，多么热爱你，你找回了令旗，救了我一命，我真的不知道如何表达我对你的感激和热爱，我用我对英雄的礼节吧！（赵国大将军李牧坚实的臂膀将你紧紧拥抱，密密的胡茬扎得你如芒刺在背，你艰难的喘着气，挣脱出一只手来，颤抖着伸到大将军眼前，用坚定的眼神提醒着他。）\n"ESC"完成任务\ntalk %x# welcome.23\n"ESC"离开", me->get_name(),getoid(me)));
